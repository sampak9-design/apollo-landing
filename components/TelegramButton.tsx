...
export default function TelegramButton({ href }: Props) {
  return (
    ...
    >
      ...
      <svg
        viewBox="0 0 24 24"
        className="h-5 w-5 flex-shrink-0 fill-current sm:h-6 sm:w-6"
        aria-hidden="true"
      >
      ...
      <span className="relative z-10 whitespace-nowrap">Liberar meu acesso agora</span>

      <svg
        viewBox="0 0 24 24"
        className="h-4 w-4 flex-shrink-0 transition-transform duration-300 group-hover:translate-x-1 sm:h-5 sm:w-5"
        fill="none"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
